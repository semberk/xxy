...
parser.add_argument('BMat', type=float, nargs=5, help="input $5$ components of Tensor B to have anisotropic surface energy and KI_C & KII=\psi*KI_C")
args = parser.parse_args()

B_11, B_12, B_22, KI, psi= Constant(args.BMat[0]), Constant(args.BMat[1]), Constant(args.BMat[2]), Constant(args.BMat[3]), Constant(args.BMat[4])
...
# Geometry paramaters
L = 0.2; hsize = 1.0e-3; N=int(L/hsize);
cra_w=0.5*hsize; cra_angle=1.0*pi/180.; 
